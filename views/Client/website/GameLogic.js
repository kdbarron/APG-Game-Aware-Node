        ...
        enemyInformationArea.update = function () {
            if (enemyMetadataForFrame != null && enemyMetadataForFrame.waveNumber != waveNumber) {
                ...
                for (var i = 0; i < enemyMetadataForFrame.info.length; i++) {
                    ...
                    var enemyHealthBar = new Phaser.Sprite(apg.g, 110, 30, 'assets/Rectangle.png');
                    ...
                    var enemySpeedBar = new Phaser.Sprite(apg.g, 110, 50, 'assets/Rectangle.png');
                    ...
                    var enemyAttackBar = new Phaser.Sprite(apg.g, 110, 70, 'assets/Rectangle.png');
