...
function InitializeGame(apg) {
    ...
    });
    {
        ...
        var radiusHighlightHolder = new Phaser.Sprite(apg.g, 0, 140, 'assets/Rectangle.png');
        ...
        var radiusToggleText = new Phaser.Text(apg.g, 10, 20, "", { font: '12px Helvetica', fill: '#C0C0C0' });
